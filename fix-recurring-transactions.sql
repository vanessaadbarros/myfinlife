...
-- Permite cadastrar despesas e receitas que se repetem

-- Verificar se a tabela já existe
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'recurring_transactions') THEN
    ...
    ELSE
        RAISE NOTICE 'Tabela recurring_transactions já existe.';
    END IF;
END $$;
